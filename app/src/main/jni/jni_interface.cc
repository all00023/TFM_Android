...
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_setSonidosSimultaneos(
        JNIEnv *__unused env,
        jobject __unused obj,
        jint sonidosSim
) {
    app.setSonidosSimultaneos(sonidosSim);
}

// StartAudio - Start audio engine and initialize player.
extern "C" JNIEXPORT void
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_startAudio(
        JNIEnv *__unused env,
        jobject  __unused obj,
        jint samplerate,
        jint buffersize,
...
extern "C" JNIEXPORT void
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_audioOnBackground(
        JNIEnv *__unused env,
        jobject __unused obj
) {
...
extern "C" JNIEXPORT void
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_audioOnForeground(
        JNIEnv *__unused env,
        jobject __unused obj
) {
...
// Cleanup - Free resources.
extern "C" JNIEXPORT void
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_audioCleanup(
        JNIEnv *__unused env,
        jobject __unused obj
) {
    app.audioCleanUp();
