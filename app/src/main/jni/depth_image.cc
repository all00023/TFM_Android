...
// timestamp t0 with respect the rgb camera's frame on timestamp t1.
    ...
    void DepthImage::asignarSonidoAElementos(Elemento3D *p1, Elemento3D *p2, Elemento3D *p3,
        ...
        if (p2 == NULL) {
            ...
            pitch2 = invertirYModificarRango(p2->getNumeroPuntos(), tamMinimo, pitchMaximo, preEscalaPitch) - pitchDiff;
        }
        ...
        if (p3 == NULL) {
            ...
            pitch3 = invertirYModificarRango(p3->getNumeroPuntos(), tamMinimo, pitchMaximo, preEscalaPitch) - pitchDiff;
        }
