...
public class TangoJNINative {
    ...
    public static native void setMute(boolean on);

    public static native void setModoVision(int modo);

    public static native void onDisplayChanged(int displayRotation, int colorCameraRotation);

    public static native void setSonidosSimultaneos(int modo);

    public static native void startAudio(int samplerate, int buffersize, String path, int offset, int length);

    public static native void audioOnBackground();

    public static native void audioOnForeground();

    public static native void audioCleanup();
